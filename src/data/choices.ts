...
export const CHOICE_POOLS: Record<string, ChoicePool> = {
  lane_decision: {
    id: 'lane_decision',
    phase: 'lane',
    ...
    options: [
      ...
      {
        id: 'lane_safe',
        text: 'Farm safely and ping missing.',
      ...
      {
        id: 'lane_rotate',
        text: 'Let it go. Rotate to help mid.',
  ...
  early_objective: {
    ...
    options: [
      ...
      {
        id: 'early_pressure',
        text: "Push mid first. I'll be there.",
      ...
      {
        id: 'early_ward',
        text: 'Ward the dragon pit first.',
  ...
  mid_fight: {
    ...
    options: [
      ...
      {
        id: 'mid_bait',
        text: 'Fake baron. Fight if they come.',
      ...
      {
        id: 'mid_delay',
        text: 'Not yet. Vision and next spawn.',
  ...
  late_call: {
    ...
    options: [
      {
        id: 'late_flank',
        text: 'Solo flank. Make the highlight play.',
      ...
      {
        id: 'late_siege',
        text: 'Group and siege methodically.',
  ...
  final_engage: {
    ...
    options: [
      {
        id: 'final_hard_engage',
        text: 'Hard engage. Go in now.',
      ...
      {
        id: 'final_kite',
        text: 'Kite back and pick off stragglers.',
      ...
      {
        id: 'final_reset',
        text: 'Call a reset. Regroup and try again.',
